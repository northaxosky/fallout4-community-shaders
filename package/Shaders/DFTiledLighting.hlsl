...
#error "DFTILEDLIGHTING_VARIANT must be 0, 1, 2, or 3"
#endif

#if DFTILEDLIGHTING_VARIANT < 0 || DFTILEDLIGHTING_VARIANT > 3
#error "DFTILEDLIGHTING_VARIANT must be 0, 1, 2, or 3"
#endif

#if DFTILEDLIGHTING_VARIANT == 0
#include "DFTiledLighting/DepthBoundsCS.hlsli"
#elif DFTILEDLIGHTING_VARIANT == 3
#include "DFTiledLighting/TileCullCS.hlsli"
#else
