...
// producer evidence supersedes that by-index tool. Authoritative producer WARP
// evidence now covers this source family; consumer conformance publication is
// deferred until the generalized source replaces the narrower shipping copy.
