...
# Exact commit named by the DearModdingUI fingerprint.
set(IMGUI_UPSTREAM_COMMIT "9acdfbf46810c0c74ab281ce04122c4149ae8bd1")

if (NOT "docking-experimental" IN_LIST FEATURES)
    message(FATAL_ERROR "This overlay port pins a docking-branch commit; enable the docking-experimental feature.")
endif()

vcpkg_from_github(
    OUT_SOURCE_PATH SOURCE_PATH
    REPO ocornut/imgui
    REF "${IMGUI_UPSTREAM_COMMIT}"
    SHA512 f711aa6376d01de094105b6c71d83d567906331396fa6b63d37b8a1a0f84b30d0b54da01bc00a8c662629f942c847acd5d01fc9f5dbdd132a76113d80252aba5
    HEAD_REF docking
)
