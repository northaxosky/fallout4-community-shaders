...
# CMAKE_GENERATOR_PLATFORM is unset (Ninja). Appending anything else to the
# variable breaks the configure.

add_subdirectory(${CMAKE_SOURCE_DIR}/extern/FidelityFX-SDK/sdk FidelityFX-SDK EXCLUDE_FROM_ALL)
...
if(NOT CMAKE_GENERATOR MATCHES "Visual Studio")
  set(_ffx_dx11_bindir
      "${CMAKE_BINARY_DIR}/FidelityFX-SDK/src/backends/dx11"
  )
  file(MAKE_DIRECTORY "${_ffx_dx11_bindir}")
  foreach(
    _ffx_bogus_dep
...
target_include_directories(FO4CommunityShaders PRIVATE
  "${CMAKE_SOURCE_DIR}/extern/FidelityFX-SDK/sdk/include"
)
