...
namespace cs::features::catalog
{
	namespace
	{
		...
		{
			// Opcodes sit at column 0; use (?:^|\n), not multiline flag, because MSVC <regex> lacks regex_constants::multiline on windows-2022; same counts, fewer comment false positives.
